...
Example usage:
    from confluence_assistant_skills.mock import MockConfluenceClient
...
Custom mock with specific mixins:
    from confluence_assistant_skills.mock.base import MockConfluenceClientBase
    from confluence_assistant_skills.mock.mixins import PageMixin, SpaceMixin
